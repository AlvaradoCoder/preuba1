...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 4:
            ...
            document.getElementById('noBtn').innerHTML = 'Di que si por favor?esposaa!';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 6:
            ...
            document.getElementById('noBtn').innerHTML = 'Si, dices que no estaré muy triste :c';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 10:
            ...
            document.getElementById('noBtn').innerHTML = 'Weno, ya dejaré de preguntar...';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
